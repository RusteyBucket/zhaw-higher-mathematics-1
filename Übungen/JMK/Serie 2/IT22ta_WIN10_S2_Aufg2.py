...
plt.show()
## Bei der Funktion F1 werden die Rundungsfehler bei der Addition und Subtraktion bei jeder erneuten Multiplikation
# erneut mit einberechnet und daher vergrössert.
## Die Unterschiede sind auf numerischen Rundungsfehler zurückzuführen die beim berechnen und darstellen von
# Fliesskommazahlen in Python auftreten können.
