...
## The difference in execution times between Serie8_Aufg2(A) and np.linalg.qr(A) is due to the efficiency of the
# algorithms used and the optimization done in the numpy library.
