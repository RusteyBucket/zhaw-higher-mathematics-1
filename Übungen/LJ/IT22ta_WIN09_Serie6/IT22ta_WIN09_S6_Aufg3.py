...
print(
		f"Das Resultat mit unserer Berechnung lautet {x1}."
		f" Das Resultat mit numpy.linalg.solve() lautet: {x2}."
		f" det: {det}",
)
...
# Für kleine Matrizen gibt es keine Unterschiede zwischen unserer Methode und der von numpy. Für die oben angegebene
# 8x8 Matrix jedoch gibt es einen Unterschied.
# Mit numpy.linalg.solve() erhalten wir: 2.12233332e-15, und mit unserer Methode erhalten wir: 5.81353147e-14. Dies
# kommt daher, dass wir nicht mit der
