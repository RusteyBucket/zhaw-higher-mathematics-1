...
print("Überprüfung Aufgabe 1:")
print(sekantenVerfahren(f1, -1, -1.2, 10 ** (-3)))

print("Überprüfung Aufgabe 2:")
...
# Beim Versuch das Newton-Verfahren zu implementieren würden wir auf Probleme bei der Ableitung von f stossen. Wir
# müssten
