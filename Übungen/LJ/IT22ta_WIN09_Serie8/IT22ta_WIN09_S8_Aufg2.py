...
print(
		"Die Laufzeit1 unserer eigenen Funktion beträgt: {} und die Laufzeit von linalg.qr() beträgt {} für eine 3x3 "
		"Matrix".format(
				avg_t1, avg_t2,
		),
)
print(
		"Unsere Funktion ist {} mal langsamer für eine 3x3 Matrix".format(avg_t1 / avg_t2),
)

# Aufgabe 2d)
Test = np.random.rand(100, 100)
t3 = timeit.repeat(
		"Serie8_Aufg2(Test)", "from __main__ import Serie8_Aufg2, Test", number = 100,
)
...
print(
		"Die Laufzeit unserer eigenen Funktion beträgt: {} und die Laufzeit von linalg.qr() beträgt {} für eine "
		"100x100 Matrix".format(
				avg_t3, avg_t4,
		),
)
print(
		"Unsere Funktion ist {} mal langsamer bei der Berechnung einer 100x100 Matrix".format(
				avg_t3 / avg_t4,
		),
)
print(
		"Unsere Funktion wird von einer 3x3-Matrix zu einer 100x100-Matrix um den Faktor {} langsamer.".format(
				avg_t3 / avg_t1,
		),
)
print(
		"Die interne Funktion von Python wird nur {} mal langsamer".format(avg_t4 / avg_t2),
)

# Die Laufzeit1 unserer eigenen Funktion beträgt: 2.472667198162526e-05 und die Laufzeit von linalg.qr() beträgt
# 9.948334016371518e-06 für eine 3x3 Matrix
# Unsere Funktion ist 2.485508823983363 mal langsamer für eine 3x3 Matrix
# Die Laufzeit unserer eigenen Funktion beträgt: 0.025264274747984018 und die Laufzeit von linalg.qr() beträgt
# 0.0007007724979193881 für eine 100x100 Matrix
