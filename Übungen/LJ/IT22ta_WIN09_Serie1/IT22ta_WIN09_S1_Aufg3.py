...
# fact_for ist um ein Faktor 11 schneller als fact_rec. Dies kommt daher, dass die rekursive Funktion mehrmals
# aufgerufen
# werden muss und der Wert mehrmals durch die if Abfragen durch muss, wobei er in der for Schleife einfach straight
# forward berechnet werden kann.
...
# Die größte darstellbare positive Gleitkommazahl in Python ist in der Regel etwa 1.8 × 10^308, und die kleinste
# darstellbare positive Gleitkommazahl
# ist etwa 5.0 × 10^-324. Wenn eine Gleitkommazahl einen größeren Wert erreicht, wird sie als "inf" (Unendlich)
# dargestellt, was auf einen Überlauf
# hinweist. Wenn eine Gleitkommazahl kleiner als die kleinste darstellbare positive Zahl wird, wird sie als Null
# dargestellt.