...
This GitHub repository comprises a set of Python scripts addressing a diverse range of problems in numerical computing.
Whether you are getting started with Python programming or delving into advanced numerical methods, this repository
...
- **Numerical Solution of Linear Systems of Equations**: Numerische Lösung linearer Gleichungssysteme
	- Gaussian Algorithm with Error Propagation and Pivoting: Gauss-Algorithmus mit Fehlerfortpflanzung und
	  Pivotisierung
